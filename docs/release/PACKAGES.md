...
The accepted package graph is recorded in `eng/package-topology.json` and ADR 0025. It contains twelve domain and evidence-contract libraries. CLI, workspace orchestration, application services, AI, UI contracts, Avalonia components, previews, samples, and tests are not packages.
...
6. loads all twelve expected assemblies;
