...
This plan defines the fixture and comparator catalog needed before C# Deduplication can claim local implementation completion or PHP compatibility. Existing PHP tests and app behavior are source evidence, not generated golden fixtures.
